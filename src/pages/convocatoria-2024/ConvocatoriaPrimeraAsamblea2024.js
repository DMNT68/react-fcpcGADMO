...
export const ConvocatoriaPrimeraAsamblea2024 = () => {
  const classes = useStyles();
  const title = 'Convocatoria a la primera asamblea general ordinaria de participes - 2024';
  const nameFile = 'CONVOCATORIA-PRIMERA-ASAMBLEA-ORDINARIA-FCPC-GADMO-21-DE-MARZO-2024.pdf';
  const url = `${URL_FONDO}/files/asamblea-2024/primera/${nameFile}`;
  return (
    <>
      <Helmet>
        <title>
