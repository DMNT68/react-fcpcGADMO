...
export const ManualAdministracionDelPersonal = () => {
  const classes = useStyles();
  const title = 'MANUAL DE ADMINISTRACIÓN DEL PERSONAL';
  const nameFile = '12.2-MANUAL-DE-ADMINISTRACIÓN-DEL-PERSONAL.pdf';
