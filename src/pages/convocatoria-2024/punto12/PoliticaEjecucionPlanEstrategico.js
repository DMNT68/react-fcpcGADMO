...
export const PoliticaEjecucionPlanEstrategico = () => {
  const classes = useStyles();
  const title = 'POLITICA DE EJECUCION PLAN ESTRATEGICO';
  const nameFile = '12.4-POLITICA-DE-EJECUCION-PLAN-ESTRATEGICO.pdf';
