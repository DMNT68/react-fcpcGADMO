...
export const ConvocatoriaTerceraAsamblea2024 = () => {
  const classes = useStyles();
  const title = 'Convocatoria a la tercera asamblea extra ordinaria - 25 de julio 2024';
  const nameFile = '1.CONVOCATORIA-ASAMBLEA-EXTRAORDINARIA-FCPC-GADMO-EMAPAO-25-DE-JULIO-2024.pdf';
  const url = `${URL_FONDO}/files/asamblea-2024/tercera/${nameFile}`;
  return (
    <>
      <Helmet>
        <title>
