...
export const PoliticaActualizacionManuales = () => {
  const classes = useStyles();
  const title = 'POLITICA DE ACTUALIZACION DE MANUALES';
  const nameFile = '11.10-POLITICA-DE-ACTUALIZACION-DE-MANUALES.pdf';
