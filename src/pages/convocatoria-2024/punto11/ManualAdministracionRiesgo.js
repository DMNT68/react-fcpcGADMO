...
export const ManualAdministracionRiesgo = () => {
  const classes = useStyles();
  const title = 'MANUAL PARA LA ADMINISTRACION DEL RIESGO';
  const nameFile = '11.7-MANUAL-PARA-LA-ADMINISTRACION-DEL-RIESGO.pdf';
