...
export const ConvocatoriaSegundaAsamblea2024 = () => {
  const classes = useStyles();
  const title = 'Convocatoria a la segunda asamblea extra ordinaria - 17 de mayo 2024';
  const nameFile = '1.CONVOCATORIA-SEGUNDA-ASAMBLEA-EXTRA-ORDINARIA-FCPC-GADMO-17-DE-MAYO-2024.pdf';
  const url = `${URL_FONDO}/files/asamblea-2024/segunda/${nameFile}`;
  return (
    <>
      <Helmet>
        <title>
