...
export const ConvocatoriaAsamblea2 = ({ setPaginaActive }) => {
  const classes = useStyles();

  return (
    <>
      <Helmet>
        <title>Segunda asamblea general extraordinaria - 2023 - 03 de mayo 2023 | fcpcGADMO</title>
      </Helmet>
      <Container maxWidth="md" id="contacto">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Hidden only={['xs']}>
            <iframe title="pdf" src="https://fcpcgadmo.com.ec/files/CONVOCATORIA-ASAMBLEA-EXTRAORDINARIA-OTAVALO-MAYO-2023.pdf" width="100%" height="500px"></iframe>
          </Hidden>
          <Hidden only={['md', 'xl', 'lg', 'sm']}>
            <div>
              <p>
                Abrir PDF &nbsp;
                <a rel="noreferrer" href="https://fcpcgadmo.com.ec/files/CONVOCATORIA-ASAMBLEA-EXTRAORDINARIA-OTAVALO-MAYO-2023.pdf" target="_blank">
                  aquí
                </a>
                .
              </p>
