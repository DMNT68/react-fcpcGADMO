...
export const ConvocatoriaAsamblea = ({ setPaginaActive }) => {
  ...
  return (
    <>
      <Helmet>
        <title>PRIMERA ASAMBLEA GENERAL ORDINARIA DE PARTICIPES - FCPC GADMO EMAPA | fcpcGADMO</title>
      </Helmet>
      <Container maxWidth="md" id="contacto">
        <Grow in={true} style={{ transformOrigin: '0 0 0' }} {...(true ? { timeout: 800 } : {})}>
          <Typography variant="h4" color="initial" align="center" className={classes.title}>
            PRIMERA ASAMBLEA GENERAL ORDINARIA DE PARTICIPES - FCPC GADMO EMAPA.
          </Typography>
        </Grow>
        <Lines height={3} />
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Hidden only={['xs']}>
            <iframe title="pdf" src="https://fcpcgadmo.com.ec/files/CONVOCATORIA-PRIMERA-ASAMBLEA-GENERAL-ORDINARIA-2023-FCPC-GADMO.pdf" width="100%" height="500px"></iframe>
          </Hidden>
          <Hidden only={['md', 'xl', 'lg', 'sm']}>
            <div>
              <p>
                Abrir PDF &nbsp;
                <a rel="noreferrer" href="https://fcpcgadmo.com.ec/files/CONVOCATORIA-PRIMERA-ASAMBLEA-GENERAL-ORDINARIA-2023-FCPC-GADMO.pdf" target="_blank">
                  aquí
                </a>
                .
              </p>
