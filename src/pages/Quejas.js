...
export const Quejas = ({ setPaginaActive }) => {
  const classes = useStyles();

  return (
    <>
      <Helmet>
        <title>QUEJAS Y SUGERENCIAS. | fcpcGADMO</title>
      </Helmet>
      <Container maxWidth="md" id="contacto">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Hidden only={['xs']}>
            <iframe title="pdf" src="https://firebasestorage.googleapis.com/v0/b/tiempos-601b6.appspot.com/o/fcpc%2FCOMUNICADO-QUEJAS-FCPC-32.pdf?alt=media&token=3dc58d5c-c26f-4c7a-8cce-a02adaa5cfb8" width="100%" height="500px"></iframe>
          </Hidden>
          <Hidden only={['md', 'xl', 'lg', 'sm']}>
            <div>
              <p>
                Abrir PDF &nbsp;
                <a rel="noreferrer" href="https://firebasestorage.googleapis.com/v0/b/tiempos-601b6.appspot.com/o/fcpc%2FCOMUNICADO-QUEJAS-FCPC-32.pdf?alt=media&token=3dc58d5c-c26f-4c7a-8cce-a02adaa5cfb8" target="_blank">
                  aquí
                </a>
                .
              </p>
