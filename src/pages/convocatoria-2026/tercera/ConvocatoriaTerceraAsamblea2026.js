...
export const ConvocatoriaTerceraAsamblea2026 = () => {
	const classes = useStyles();
	const title = 'Convocatoria a la tercera asamblea general extraordinaria - 2026';
	const nameFile = '1-CONVOCATORIA-ASAMBLEA-EXTRAORDINARIA-04-DE-JUNIO-2026.pdf';
	const url = `${URL_FONDO}/files/asamblea-2026/tercera/${nameFile}`;
	return (
		<>
			<Helmet>
				<title>
