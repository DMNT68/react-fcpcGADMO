...
export const ConvocatoriaSegundaAsamblea2026 = () => {
	const classes = useStyles();
	const title = 'Convocatoria a la segunda asamblea general extraordinaria - 2026';
	const nameFile = '1-CONVOCATORIA-ASAMBLEA-EXTRAORDINARIA-19-DE-MAYO-2026.pdf';
	const url = `${URL_FONDO}/files/asamblea-2026/segunda/${nameFile}`;
	return (
		<>
			<Helmet>
				<title>
