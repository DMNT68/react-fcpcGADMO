...
export const ConvocatoriaPrimeraAsamblea2026 = () => {
	const classes = useStyles();
	const title = 'Convocatoria a la primera asamblea general ordinaria - 2026';
	const nameFile = '1-CONVOCATORIA-ASAMBLEA-ORDINARIA-FCPC-GADMO-12-DE-MARZO-2026.pdf';
	const url = `${URL_FONDO}/files/asamblea-2026/primera/${nameFile}`;
	return (
		<>
			<Helmet>
				<title>
