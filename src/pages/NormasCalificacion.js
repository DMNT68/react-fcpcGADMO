...
export const NormasCalificacion = ({ setPaginaActive }) => {
  const classes = useStyles();

  return (
    <>
      <Helmet>
        <title>NORMAS PARA LA CALIFICACION DE REPRESENTANTE LEGAL DEL FCPC GADMO EMAPAO. | fcpcGADMO</title>
      </Helmet>
      <Container maxWidth="md" id="contacto">
        <Grow in={true} style={{ transformOrigin: '0 0 0' }} {...(true ? { timeout: 800 } : {})}>
          <Typography variant="h4" color="initial" align="center" className={classes.title}>
            NORMAS PARA LA CALIFICACION DE REPRESENTANTE LEGAL DEL FCPC GADMO EMAPAO.
          </Typography>
        </Grow>
        <Lines height={3} />
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <Hidden only={['xs']}>
            <iframe title="pdf" src="https://fcpcgadmo.com.ec/files/NORMAS-PARA-LA-CALIFICACI%C3%93N-DECLARACI%C3%93N-DE-INHABILIDAD-Y-REMOCI%C3%93N-DEL-REPRESENTANTE-LEGAL-DE-LOS-FCPC.pdf" width="100%" height="500px"></iframe>
          </Hidden>
          <Hidden only={['md', 'xl', 'lg', 'sm']}>
            <div>
              <p>
                Abrir PDF &nbsp;
                <a rel="noreferrer" href="https://fcpcgadmo.com.ec/files/NORMAS-PARA-LA-CALIFICACI%C3%93N-DECLARACI%C3%93N-DE-INHABILIDAD-Y-REMOCI%C3%93N-DEL-REPRESENTANTE-LEGAL-DE-LOS-FCPC.pdf" target="_blank">
                  aquí
                </a>
                .
              </p>
