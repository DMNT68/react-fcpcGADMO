...
export const MedidasDisciplinarias = ({ setPaginaActive }) => {
      ...
      <Grow in={true} style={{ transformOrigin: '0 0 0' }} {...(true ? { timeout: 800 } : {})}>
        <Container maxWidth="md">
          ...
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.parragraph}>
            Es importante comprender que la violación de algunas disposiciones de este Código también puede implicar la violación de alguna Ley y puede hacer que el sujeto implicado y/o el <span style={{ fontWeight: 'bold' }}>FONDO DE CESANTÍA PRIVADO DE LOS EMPLEADOS, TRABAJADORES Y DOCENTES DEL GOBIERNO MUNICIPAL DE OTAVALO FCPC</span>, sean objeto de una acción legal que genere responsabilidades, administrativas, civiles o penales.
          </Typography>
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.parragraph}>
