...
export const DisposionesPreliminares = ({ setPaginaActive }) => {
    ...
    <>
      ...
      <Grow in={true} style={{ transformOrigin: '0 0 0' }} {...(true ? { timeout: 800 } : {})}>
        <Container maxWidth="md">
          ...
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.parragraph}>
            Es obligatorio el cumplimiento del Estatuto del <span style={{ fontWeight: 'bold' }}>FONDO DE CESANTIA PRIVADO DE LOS EMPLEADOS, TRABAJADORES Y DOCENTES DEL GOBIERNO MUNICIPAL DE OTAVALO FCPC</span>, sus reglamentos, códigos, políticas y resoluciones de la Junta de Política y Regulación Monetaria y Financiera, la Superintendencia de Bancos, las disposiciones del BIESS y demás leyes que regulen a los Fondos Complementarios Previsionales Cerrados.
          </Typography>
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.parragraph}>
          ...
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.parragraph}>
            Los empleados del Fondo no podrán proporcionar información propia del FCPCGADMO-EMAPAO, sin estar autorizados para ello, salvo que sea requerida por entidades de control o públicas, para el efecto siempre deberá ponerse la leyenda que la información proporcionada se entrega bajo la responsabilidad de quien lo solicite precautelando los intereses del Fondo por sigilo.
          </Typography>
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.parragraph}>
          ...
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.list}>
            El cumplimiento de los objetivos y responsabilidades asumidas en el manejo de los recursos;
          </Typography>
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.list}>
          ...
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.list} style={{ marginBottom: 16 }}>
            Presentar anualmente a la Asamblea General de partícipes la información financiera auditada.
          </Typography>
        </Container>
      </Grow>
    </>
