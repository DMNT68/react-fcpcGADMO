...
export const MedioAmbiente = ({ setPaginaActive }) => {
    ...
    <>
      ...
      <Grow in={true} style={{ transformOrigin: '0 0 0' }} {...(true ? { timeout: 800 } : {})}>
        <Container maxWidth="md">
          ...
          <Typography variant="body1" color="initial" component="p" align="justify" className={classes.parragraph}>
            Sin embargo, de que cada persona debe proteger su propia salud y seguridad, es responsabilidad de todo compañero de trabajo brindar apoyo en caso de existir alguna situación atentatoria que vaya contra la vida del otro.
          </Typography>
          <Typography variant="h5" color="initial" className={classes.subTitle}>
