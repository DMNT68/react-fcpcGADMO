...
export const ConvocatoriaCuartaAsamblea2025 = () => {
	const classes = useStyles();
	const title = 'Convocatoria a asamblea extraordinaria 28 de octubre de 2025';
	const nameFile = 'CONVOCATORIA-ASAMBLEA-FCPC-GADMO-28-DE-OCTUBRE-2025.pdf';
	const url = `${URL_FONDO}/files/asamblea-2025/cuarta/${nameFile}`;
	return (
		<>
			<Helmet>
				<title>
