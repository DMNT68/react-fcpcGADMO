...
export const ConvocatoriaPrimeraAsamblea2025 = () => {
  const classes = useStyles();
  const title = 'Convocatoria a la primera asamblea general ordinaria de participes - 2025';
  const nameFile = '1-CONVOCATORIA-PRIMERA-ASAMBLEA-ORDINARIA-2025.pdf';
