...
export const PoliticaDeActualizacionDeNormativa = () => {
  const classes = useStyles();
  const title = 'POLÍTICA DE ACTUALIZACIÓN DE NORMATIVA';
  const nameFile = '13-POLITICA-DE-ACTUALIZACION-DE-NORMATIVA.pdf';
