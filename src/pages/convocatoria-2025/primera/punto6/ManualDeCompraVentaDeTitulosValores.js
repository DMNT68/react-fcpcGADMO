...
export const ManualDeCompraVentaDeTitulosValores = () => {
  const classes = useStyles();
  const title = 'MANUAL DE COMPRA VENTA DE TITULOS VALORES';
  const nameFile = '14-MANUAL-DE-COMPRA-VENTA-DE-TITULOS-VALORES.pdf';
