...
export const ManualDeTecnologiasGeneracionDeRespaldos2 = () => {
	const classes = useStyles();
	const title = 'MANUAL DE TECNOLOGIAS GENERACION DE RESPALDOS';
	const nameFile =
		'22-MANUAL-DE-TECNOLOGIAS-GENERACION-DE-RESPALDOS-DE-INFORMACION-CONTABLE-DEL-FONDO.pdf';
