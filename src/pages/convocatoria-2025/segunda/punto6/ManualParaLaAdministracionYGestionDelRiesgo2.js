...
export const ManualParaLaAdministracionYGestionDelRiesgo2 = () => {
  const classes = useStyles();
  const title = 'MANUAL PARA LA ADMINISTRACION Y GESTION DEL RIESGO';
  const nameFile = '10-MANUAL-PARA-LA-ADMINISTRACION-Y-GESTION-DEL-RIESGO.pdf';
