...
export const ManualDeCalificacionYCastigoDeCartera2 = () => {
  const classes = useStyles();
  const title = 'MANUAL DE CALIFICACION Y CASTIGO DE CARTERA';
  const nameFile = '15-MANUAL-DE-CALIFICACION-Y-CASTIGO-DE-CARTERA.pdf';
