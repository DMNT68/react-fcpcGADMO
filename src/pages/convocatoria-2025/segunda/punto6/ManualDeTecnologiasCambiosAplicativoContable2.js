...
export const ManualDeTecnologiasCambiosAplicativoContable2 = () => {
	const classes = useStyles();
	const title = 'MANUAL DE TECNOLOGÍAS CAMBIOS EN EL APLICATIVO CONTABLE';
	const nameFile = '21-MANUAL-DE-TECNOLOGIAS-CAMBIOS-EN-EL-APLICATIVO-CONTABLE-DEL-FONDO.pdf';
	const url = `${URL_FONDO}/files/asamblea-2025/segunda/${nameFile}`;
	return (
		<>
			<Helmet>
				<title>
