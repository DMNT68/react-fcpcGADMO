...
export const ManualDeArchivoYGestionDocumental2 = () => {
  const classes = useStyles();
  const title = 'MANUAL DE ARCHIVO Y GESTION DOCUMENTAL';
  const nameFile = '17-MANUAL-DE-ARCHIVO-Y-GESTION-DOCUMENTAL.pdf';
