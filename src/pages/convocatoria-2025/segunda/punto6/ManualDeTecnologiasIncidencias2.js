...
export const ManualDeTecnologiasIncidencias2 = () => {
	const classes = useStyles();
	const title = 'MANUAL DE TECNOLOGIAS INCIDENCIAS';
	const nameFile = '20-MANUAL-DE-TECNOLOGIAS-INCIDENCIAS-EN-EL-APLICATIVO-CONTABLE-DEL-FONDO.pdf';
