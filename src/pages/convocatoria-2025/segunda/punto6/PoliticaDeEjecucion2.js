...
export const PoliticaDeEjecucion2 = () => {
	const classes = useStyles();
	const title = 'POLÍTICA DE EJECUCIÓN PLAN ESTRATEGICO Y PLANIFICACIÓN OPERATIVA ANUAL';
	const nameFile = '18-POLITICA-DE-EJECUCION-PLAN-ESTRATEGICO-Y-PLANIFICACION-OPERATIVA.pdf';
