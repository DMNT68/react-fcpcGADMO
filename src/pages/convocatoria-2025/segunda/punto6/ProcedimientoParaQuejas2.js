...
export const ProcedimientoParaQuejas2 = () => {
	const classes = useStyles();
	const title = 'PROCEDIMIENTO PARA TRATAMIENTO DE QUEJAS Y SUGERENCIAS.';
	const nameFile = '23-PROCEDIMIENTO-PARA-ATENCION-DE-QUEJAS-Y-SUGERENCIAS.pdf';
