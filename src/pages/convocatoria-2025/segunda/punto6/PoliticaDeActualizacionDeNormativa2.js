...
export const PoliticaDeActualizacionDeNormativa2 = () => {
	const classes = useStyles();
	const title = 'POLÍTICA DE ACTUALIZACIÓN DE MANUALES Y NORMATIVAS';
	const nameFile = '13-POLITICA-DE-ACTUALIZACION-DE-MANUALES.pdf';
