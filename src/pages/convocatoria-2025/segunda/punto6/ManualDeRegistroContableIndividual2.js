...
export const ManualDeRegistroContableIndividual2 = () => {
  const classes = useStyles();
  const title = 'MANUAL DE REGISTRO DE CUENTA INDIVIDUAL';
  const nameFile = '7-MANUAL-DE-REGISTRO-DE-CUENTA-INDIVIDUAL.pdf';
