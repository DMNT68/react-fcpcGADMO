...
export const ConvocatoriaSegundaAsamblea2025 = () => {
	const classes = useStyles();
	const title = 'Convocatoria a la segunda asamblea general ordinaria de participes - 2025';
	const nameFile = '1-CONVOCATORIA-ASAMBLEA-EXTRA-ORDINARIA-2025.pdf';
