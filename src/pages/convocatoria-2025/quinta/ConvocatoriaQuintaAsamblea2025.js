...
export const ConvocatoriaQuintaAsamblea2025 = () => {
	const classes = useStyles();
	const title = 'Convocatoria a quinta asamblea extraordinaria';
	const nameFile =
		'1.CONVOCATORIA-CUARTA-ASAMBLEA-11-DE-NOVIEMBRE-2025-FCPC-IMI-signed.pdf';
	const url = `${URL_FONDO}/files/asamblea-2025/quinta/${nameFile}`;
	return (
		<>
			<Helmet>
				<title>
